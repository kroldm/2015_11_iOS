...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func populateDatabase(){
        for i in 0..<1000{
            ...
            person.age = Int(arc4random_uniform(120))
        }
        do{
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ofer1.Core_data" in the application's documents Application Support directory.
